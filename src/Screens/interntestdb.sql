...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 02, 2020 at 02:59 PM
...
CREATE TABLE `tbluser` (
  ...
  `option_eat` varchar(255) NOT NULL,
  `answer_eat` varchar(255) NOT NULL,
  `option_movies` varchar(255) NOT NULL,
  `answer_movies` varchar(255) NOT NULL,
  `option_tv` varchar(255) NOT NULL,
  `answer_tv` varchar(255) NOT NULL,
  `option_radio` varchar(255) NOT NULL,
  `answer_radio` varchar(255) NOT NULL
...
INSERT INTO `tbluser` (`userID`, `surname`, `firstname`, `phone`, `date`, `age`, `fav_food`, `option_eat`, `answer_eat`, `option_movies`, `answer_movies`, `option_tv`, `answer_tv`, `option_radio`, `answer_radio`) VALUES
(2, 'adfdfaadgf', 'dfgdafgdagfda', 'dfadfgdgdg', 'adgfdgadgdf', 25, 'Pasta', 'eat out', 'Strongly agree', 'Movies', 'Agree', 'TV', ' Neutral', 'Radio', 'Disagree'),
(3, 'Dlamini', 'Teko', '0657485654', '21 Jan 2018', 42, 'Pasta', 'eat out', ' Strongly agree', 'Movies', ' Strongly agree', 'TV', '', 'Radio', ' Strongly agree'),
(4, 'Nkuna', 'Jeff', 'asasdadd', 'asdadada', 55, 'Pizza', 'eat out', 'Agree', 'Movies', 'Neutral', 'TV', ' Disagree', 'Radio', 'Agree'),
(5, 'Carol', 'Khune', '6854785647', '22 Jan 2017', 16, 'Pap and Wors', 'eat out', 'Strongly agree', 'Movies', 'Agree', 'TV', ' Neutral', 'Radio', 'Agree'),
(6, 'Dan', 'Dan', '456423445', '21 jan 2020', 74, 'Pap and Wors', 'eat out', 'Strongly agree', 'Movies', 'Agree', 'TV', ' Neutral', 'Radio', 'Disagree'),
(7, 'Tasha', 'Cobbs', '6854721465', '12 Dec 2012', 21, '', 'eat out', 'Strongly agree', 'Movies', 'Agree', 'TV', ' Agree', 'Radio', 'Strongly agree'),
(8, 'Tasha', 'Cobbs', '6854721465', '12 Dec 2012', 21, 'Pasta', 'eat out', 'Strongly agree', 'Movies', 'Agree', 'TV', ' Agree', 'Radio', 'Strongly agree');
